...
full_html = response.html.html  # Save the full HTML content
text_content = response.html.text  # Extract clean text content (without HTML tags)
...
data = {
    ...
    "html_content": full_html,      # Full HTML content
    "text_content": text_content    # Clean text content
}
